...
export const metadata: Metadata = {
    title: "Développeur Web Var | Webdevfred",
    description: "Développeur Web Var, Webdevfred pour la création de site internet professionnel. Je conçois des sites performants et sur mesure.",
    keywords: "développeur web var,création de site internet professionnel, site web professionnel, développement web, conception site web, WebDevFred",
    openGraph: {
      title: "Développeur Web Var | Webdevfred",
      description: "Développeur Web Var, Webdevfred pour la création de site internet professionnel. Je conçois des sites performants et sur mesure.",
      url: "https://webdevfred.fr/developpeur-web-var",
      type: "website",
      images: [
        {
...
export default function DeveloppeurWebVar() {
  return (
